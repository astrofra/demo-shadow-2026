...
-- {type = "instance_animation", id = "phone_ring_anim", animation = "still"}
	...
	{type = "camera", camera = "Camera_Ground_0"},
	...
	{type = "camera", camera = "Camera_Indoor_0"},
    {type = "move", start = "path_1", target = "path_2"},
	{type = "camera", camera = "Camera_Angle_0"},
	...
	{type = "arm_amplitude", side = "right", value = 1.0},
